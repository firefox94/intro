...
st.write("""
    - 5+ years in Data Domain
    - Strong hand-on building ML models and AI applications
    - Good problems solving and detecing bussiness paint points
    """)
...
st.write("""
    ...
    - Data visualization: Excel, PowerBI, Plotly
    - Modeling: Suppervise (Regression, Classification), Unsupervise (Clustering, PCA)
